export default function FaikeTermsPage() {
  return (
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-10 text-base leading-7 text-neutral-700">
          <section>
            ...
            <p>
              By downloading, installing, or using FAIKE (&quot;the App&quot;),
          ...
          <section>
            ...
            <p className="mb-3">
              FAIKE is an AI-powered content verification tool that provides:
            </p>
          ...
          <section>
            ...
            <p className="font-semibold text-neutral-900">
              FAIKE provides AI-generated assessments and should not be treated
              as definitive truth.
            </p>
            <p className="mt-3">
              Results are probabilistic estimates based on available information
              and AI analysis. We do not guarantee the accuracy, completeness, or
              reliability of any analysis.
            </p>
            <p className="mb-3 mt-3">You should:</p>
            <ul className="list-disc space-y-2 pl-6">
            ...
            <p className="mt-3">
              FAIKE is not a substitute for professional fact-checking, legal
              advice, medical advice, or expert opinion.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              FAIKE offers a limited number of free scans that reset every 30
              days.
            </p>
            ...
            <p className="mb-3">
              FAIKE Pro is available as an auto-renewable subscription with the
              following options:
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Monthly:</strong> Free trial for the first month, then
                the displayed monthly price
              </li>
              <li>
                <strong>Yearly:</strong> Billed annually at the displayed yearly
                price
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                Any unused portion of a free trial period is forfeited when you
            ...
            <p>
              We reserve the right to change subscription prices. Price changes
              will take effect at the start of the next subscription period
          ...
          <section>
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                Submit content that is illegal, harmful, or violates third-party
                rights
              </li>
              <li>Attempt to circumvent usage limits or security measures</li>
              <li>
                Use the App&apos;s AI capabilities for purposes other than
                content verification
              </li>
              <li>
                Resell, redistribute, or commercially exploit the App or its
                outputs
              </li>
          ...
          <section>
            ...
            <p>
              ...
              the property of New Age Technologies Ltd. and is protected by
          ...
          <section>
            ...
            <p>
              You retain ownership of any content you submit to the App for
              analysis. By submitting content, you grant us a limited licence to
              process that content for the purpose of providing the service. We
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless New Age Technologies Ltd.
          ...
          <section>
            ...
            <p>
              ...
              App at any time, with or without cause, with or without notice.
          ...
          <section>
            ...
            <p>
              ...
              material changes by posting the updated Terms within the App. Your
