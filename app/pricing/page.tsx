...
export default function Pricing() {
  ...
  return (
<div className="min-h-screen bg-black pt-4 pb-8 relative overflow-hidden">
    <div
      className="absolute left-1/2 top-1/4 w-[420px] h-[420px] blur-[100px] pointer-events-none opacity-10"
      style={{
        background:
    ...
    <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center gap-3 mt-5">
          <div className="bg-white/5 p-1.5 rounded-full border border-white/10 flex items-center relative">
            <button
              ...
              className={`px-5 py-2 text-sm font-medium rounded-full transition-all duration-300 z-10 ${
            ...
            <div
              className={`absolute top-1.5 bottom-1.5 left-1.5 w-[calc(50%-6px)] bg-white/10 rounded-full transition-transform duration-300 ease-out ${
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-8">
        {/* Free */}
        <div className="flex flex-col bg-blue-500/[0.02] backdrop-blur-2xl border border-white/5 rounded-3xl p-7 hover:border-blue-500/20 transition-all duration-500">
          <div className="mb-5">
            <h3 className="text-lg font-normal text-white/40 mb-2">Free</h3>
        ...
        {/* Basic */}
        <div className="flex flex-col bg-blue-500/[0.05] backdrop-blur-2xl border border-blue-500/20 rounded-3xl p-7 hover:border-blue-500/40 transition-all duration-500 relative">
          <div className="absolute top-5 right-6">
            <span className="bg-blue-500/10 border border-blue-500/20 text-blue-400 px-2.5 py-0.5 rounded-full text-[10px] uppercase tracking-widest font-bold">
              Popular
            </span>
          </div>

          <div className="mb-5">
            <h3 className="text-lg font-normal text-white/40 mb-2">Basic</h3>
            <div className="flex items-baseline gap-1">
        ...
        <div className="flex flex-col bg-blue-500/[0.02] backdrop-blur-2xl border border-white/5 rounded-3xl p-7 hover:border-blue-500/20 transition-all duration-500">
          <div className="mb-5">
            <h3 className="text-lg font-normal text-white/40 mb-2">Pro</h3>
            <div className="flex items-baseline gap-1">
      ...
      <div className="text-center text-white/30 text-sm mt-7">
