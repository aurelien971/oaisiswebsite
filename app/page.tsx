  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="min-h-screen relative overflow-hidden py-20">
        ...
        <div className="max-w-5xl mx-auto px-3 md:px-20 relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p
className="text-lg md:text-xl mb-8 leading-relaxed text-white/50"
              style={{
        ...
        {/* FULL WIDTH VIDEO */}
<div className="max-w-8xl mx-auto px-6 md:px-80">
          <video
            autoPlay
            loop
            muted
